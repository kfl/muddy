...
(* Copyright (C) 1997-2002 by Ken Friis Larsen and Jakob Lichtenberg.        *)
    ...
    val scanallvars: (fddvar * int * Bdd.bdd) -> int array option
...
(* Documentation:
  ...
  [ithSet v], [domain v], [setPairs pairl]: Not documented, see the
  Buddy documentation.
  ...
  ?	      fdd_scanset
  makeSet     fdd_makeset
  addvarblock fdd_intaddvarblock
